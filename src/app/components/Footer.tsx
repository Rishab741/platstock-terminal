          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="group relative inline-flex items-center gap-2 px-5 py-2.5 rounded-lg overflow-hidden text-sm font-semibold"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-violet-600 to-cyan-500" />
                <span className="relative text-white">Request Access</span>
                <ArrowRight className="relative w-4 h-4 text-white/80 group-hover:translate-x-0.5 transition-transform" />
              </button>
            </div>
          </div>
